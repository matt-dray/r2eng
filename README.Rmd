...
The Raison d'être for `r2eng_from_string` is to handle some exceptional cases, e.g. expression using `=` for variable assignment above. It is also useful when you pipe an expression.
