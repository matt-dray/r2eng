...
There's an in-built dictionary, `r2eng_dictionary`, that maps R symbols to English terms:

```{r dictionary}
r2eng::r2eng_dictionary
```

I'm always seeking to expand this dictionary and improve the `r2eng_dictionary` object. You can add ideas to [this GitHub issue](https://github.com/matt-dray/r2eng/issues/1).
